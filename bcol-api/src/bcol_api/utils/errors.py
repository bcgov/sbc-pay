...
class Error(Enum):
    ...
    NOT_A_PRIME_USER = 'Not a prime user.', 'You must enter the PRIME CONTACT User ID and password for your BC Online account.', HTTPStatus.BAD_REQUEST
    SYSTEM_ERROR = 'BC Online is currently not available.', 'BC Online is currently not available. Please try again later.', HTTPStatus.BAD_REQUEST
