...
def factory_eft_header(record_type: str, file_creation_date: str, file_creation_time: str,
                       deposit_start_date: str, deposit_end_date) -> str:
    """Produce eft header TDI17 formatted string."""
    result = f'{record_type}CREATION DATE: {file_creation_date}CREATION TIME:   {file_creation_time}' \
...
def factory_eft_record(record_type: str, ministry_code: str, program_code: str,
                       deposit_date: str, deposit_time: str, location_id: str, transaction_sequence: str,
                       transaction_description: str, deposit_amount: str, currency: str,
                       exchange_adj_amount: str, deposit_amount_cad: str, destination_bank_number: str,
                       batch_number: str, jv_type: str, jv_number: str, transaction_date: str) -> str:
