...
from tests.utilities.base_test import (
    ...
    get_pad_account_payload_without_bcol)
...
def test_create_bcol_account_to_pad(session):
    ...
    # Update to PAD
    pad_account = PaymentAccountService.update(bcol_account.auth_account_id, get_pad_account_payload_without_bcol())
...
def test_create_pad_to_bcol_to_pad(session):
    """Assert that update from BCOL to PAD works."""
    # Create a PAD Account first
    pad_account_1 = PaymentAccountService.create(get_pad_account_payload_without_bcol(bank_number='009'))
    ...
    pad_account_2 = PaymentAccountService.update(pad_account_1.auth_account_id,
                                                 get_pad_account_payload_without_bcol(bank_number='010'))
