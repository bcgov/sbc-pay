...
def test_preflight_fas_refund(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/fas/routing-slips/1/refunds',
...
def test_preflight_fas_routing_slip(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/fas/routing-slips',
                        headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')

    rv = client.options('/api/v1/fas/routing-slips/queries',
                        headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')

    rv = client.options('/api/v1/fas/routing-slips/2023-09-05/reports',
                        headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')

    rv = client.options('/api/v1/fas/routing-slips/1',
                        headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET, PATCH')

    rv = client.options('/api/v1/fas/routing-slips/1/links',
                        headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET')

    rv = client.options('/api/v1/fas/routing-slips/links',
                        headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')

    rv = client.options('/api/v1/fas/routing-slips/1/comments',
                        headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
...
def test_preflight_account(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/accounts',
                        headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')

    rv = client.options('/api/v1/accounts/1',
                        headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    ...
    rv = client.options('/api/v1/accounts/1/payments/queries',
                        headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')

    rv = client.options('/api/v1/accounts/1/payments/reports',
                        headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')
...
def test_preflight_account_statements(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/accounts/1/statements',
                        headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET')

    rv = client.options('/api/v1/accounts/1/statements/1',
                        headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET')
...
def test_preflight_account_statement_notifications(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/accounts/1/statements/notifications',
                        headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET, POST')
...
def test_preflight_account_statement_settings(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/accounts/1/statements/settings',
                        headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET, POST')
...
def test_preflight_bank_accounts(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/bank-accounts/verifications',
                        headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')
...
def test_preflight_distributions(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/fees/distributions/1/schedules', headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET, POST')
...
def test_preflight_fee(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/fees/COR_TYPE/FILING_TYPE_CODE', headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET')
...
def test_preflight_invoice(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/payment-requests/1/reports', headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')
...
def test_preflight_invoice_receipt(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/payment-requests/1/receipts', headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET, POST')
...
def test_preflight_invoices(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/payment-requests/1/invoices', headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET')
...
def test_preflight_eft_shortnames(app, client, jwt, session):
    ...
    rv = client.options('/api/v1/eft-shortnames/1/links',
                        headers={'Access-Control-Request-Method': 'GET'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'GET, POST')
    ...
    rv = client.options('/api/v1/eft-shortnames/1/payment',
                        headers={'Access-Control-Request-Method': 'POST'})
    assert rv.status_code == 200
    assert_access_control_headers(rv, '*', 'POST')
