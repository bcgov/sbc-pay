...
def get_routing_slip_payment_request(
    ...
    return {
        ...
        "accountInfo": {"routingSlip": "123456789"},
        "filingInfo": {
            "filingTypes": [
                {"filingTypeCode": second_filing_type, "filingDescription": "TEST"},
...
def get_payment_request_without_bn(corp_type: str = "CP", filing_type: str = "OTADD"):
    """Return a payment request object."""
    return {
        "businessInfo": {"corpType": corp_type},
        "filingInfo": {
            "filingTypes": [
                {"filingTypeCode": filing_type, "filingDescription": "TEST"},
                {"filingTypeCode": "OTANN"},
            ]
        },
    }
...
def get_payment_request_with_service_fees(
    business_identifier: str = "CP0001234",
    corp_type: str = "BEN",
...
def get_payment_request_for_cso(csbfile_quantity: int = 2):
    ...
    return {
        ...
        "details": [{"label": "A Label", "value": "A value"}],
    }
...
def get_payment_request_with_no_contact_info(
    payment_method: str = "CC",
    corp_type: str = "CP",
    filing_type_code: str = "SERCH",
    future_effective: bool = False,
):
    """Return a payment request object."""
    return {
        "paymentInfo": {"methodOfPayment": payment_method},
        "businessInfo": {"corpType": corp_type, "businessIdentifier": "CP8765768"},
        "filingInfo": {
            "filingTypes": [
                {
...
def get_waive_fees_payment_request(business_identifier: str = "CP0001234"):
    ...
    return {
        ...
        "filingInfo": {
            "filingTypes": [
                {"filingTypeCode": "OTANN", "waiveFees": True},
                {"filingTypeCode": "OTCDR", "waiveFees": True},
            ]
        },
    }
...
def get_payment_request_for_wills(will_alias_quantity: int = 1):
    ...
    return {
        "businessInfo": {"corpType": "VS"},
        "filingInfo": {
            "filingTypes": [
                {"filingTypeCode": "WILLNOTICE"},
                {"filingTypeCode": "WILLALIAS", "quantity": will_alias_quantity},
            ]
        },
    }
...
def get_auth_staff(method_of_payment="CC"):
    ...
    return {
        "orgMembership": "OWNER",
        "roles": ["view", "edit", "make_payment", "staff"],
        "business": {"folioNumber": "MOCK1234", "name": "Mock Business"},
        "account": {
            "accountType": "BASIC",
            "id": "1234",
            "name": "Mock Account",
            "paymentInfo": {"methodOfPayment": "INTERNAL"},
        },
    }
...
def get_premium_account_payload(
    payment_method: str = PaymentMethod.DRAWDOWN.value,
...
def get_eft_enable_account_payload(
    payment_method: str = PaymentMethod.DRAWDOWN.value,
    account_id: int = randrange(999999),
):
...
def get_linked_pad_account_payload(
    account_id: int = randrange(999999),
    bank_number: str = "001",
    transit_number="999",
...
def get_unlinked_pad_account_payload(
    account_id: int = randrange(999999),
    bank_number: str = "001",
    transit_number="999",
    bank_account="1234567890",
...
def get_gov_account_payload(
    payment_method: str = PaymentMethod.EJV.value,
    account_id: int = randrange(999999),
...
def get_gov_account_payload_with_no_revenue_account(
    payment_method: str = PaymentMethod.EJV.value, account_id: int = randrange(999999)
):
    """Return a gov account payload with no revenue account."""
    return {
        "accountId": account_id,
        "accountName": "Test Account",
        "paymentInfo": {"methodOfPayment": payment_method, "billable": False},
    }
...
def factory_comments(
    routing_slip_number: str,
    username: str = "comment_user",
...
def factory_eft_history(short_name_id, refund_id, amount=10.00, credit_balance=10.00):
    ...
    return EFTShortnamesHistorical(
        short_name_id=short_name_id,
        amount=amount,
