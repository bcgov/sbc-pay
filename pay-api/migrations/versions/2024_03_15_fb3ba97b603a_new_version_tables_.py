...
def upgrade():
    ...
    with op.batch_alter_table("eft_short_names_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_eft_short_names_history_auth_account_id"),
            ["auth_account_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_eft_short_names_history_short_name"),
            ["short_name"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_method", sa.String(length=15), autoincrement=False, nullable=True
        ),
        sa.Column(
    ...
    with op.batch_alter_table("payment_accounts_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_payment_accounts_history_auth_account_id"),
            ["auth_account_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_payment_accounts_history_bcol_account"),
            ["bcol_account"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_payment_accounts_history_bcol_user_id"),
            ["bcol_user_id"],
            unique=False,
        )

    op.create_table(
        "account_fees_history",
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        ...
        sa.Column(
            "created_by", sa.String(length=50), autoincrement=False, nullable=False
        ),
        sa.Column(
    ...
    with op.batch_alter_table("account_fees_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_account_fees_history_account_id"),
            ["account_id"],
            unique=False,
        )

    op.create_table(
        "cfs_accounts_history",
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column(
    ...
    with op.batch_alter_table("cfs_accounts_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_cfs_accounts_history_account_id"),
            ["account_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_cfs_accounts_history_bank_account_number"),
            ["bank_account_number"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_cfs_accounts_history_bank_branch_number"),
            ["bank_branch_number"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_cfs_accounts_history_bank_number"),
            ["bank_number"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_cfs_accounts_history_cfs_account"),
            ["cfs_account"],
            unique=False,
        )
    ...
    with op.batch_alter_table("distribution_codes_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_distribution_codes_history_account_id"),
            ["account_id"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column(
            "payment_line_item_id", sa.Integer(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "refund_amount",
            sa.Numeric(precision=19, scale=2),
        ...
        sa.Column(
            "disbursement_date", sa.DateTime(), autoincrement=False, nullable=True
        ),
        sa.Column("created_on", sa.DateTime(), autoincrement=False, nullable=False),
        sa.Column("updated_on", sa.DateTime(), autoincrement=False, nullable=True),
        sa.Column(
    ...
    with op.batch_alter_table("refunds_partial_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_refunds_partial_history_payment_line_item_id"),
            ["payment_line_item_id"],
            unique=False,
        )
