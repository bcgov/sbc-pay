...
def downgrade():
    op.add_column('invoice', sa.Column('invoice_number', sa.String(length=50), nullable=True))
    op.add_column('invoice', sa.Column('reference_number', sa.String(length=50), nullable=True))
    op.execute('update '
               'invoice inv  '
               'set '
