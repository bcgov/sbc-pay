...
def upgrade():
    ...
    op.add_column('payment', sa.Column('cons_inv_number', sa.String(length=50), nullable=True))
    op.create_index(op.f('ix_payment_cons_inv_number'), 'payment', ['cons_inv_number'], unique=False)
