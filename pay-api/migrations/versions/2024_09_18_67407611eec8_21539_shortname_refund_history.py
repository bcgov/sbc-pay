...
def upgrade():
    with op.batch_alter_table("eft_short_names_historical", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_eft_short_names_historical_eft_refund_id"),
            ["eft_refund_id"],
            unique=False,
        )
        batch_op.create_foreign_key(
            "eft_short_names_historical_eft_refund_id_fkey",
            "eft_refunds",
            ["eft_refund_id"],
            ["id"],
        )
...
def downgrade():
    with op.batch_alter_table("eft_short_names_historical", schema=None) as batch_op:
        batch_op.drop_constraint(
            "eft_short_names_historical_eft_refund_id_fkey", type_="foreignkey"
        )
