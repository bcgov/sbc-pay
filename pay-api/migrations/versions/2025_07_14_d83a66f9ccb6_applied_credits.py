...
def upgrade():
    ...
    op.execute("ALTER INDEX IF EXISTS ix_cfs_credit_invoices_account_id RENAME TO ix_applied_credits_account_id")
    op.execute("ALTER INDEX IF EXISTS ix_cfs_credit_invoices_application_id RENAME TO ix_applied_credits_application_id")
...
def downgrade():
    ...
    op.execute("ALTER INDEX IF EXISTS ix_applied_credits_account_id RENAME TO ix_cfs_credit_invoices_account_id")
    op.execute("ALTER INDEX IF EXISTS ix_applied_credits_application_id RENAME TO ix_cfs_credit_invoices_application_id")
