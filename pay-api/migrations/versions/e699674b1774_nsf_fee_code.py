...
def upgrade():
    ...
    op.bulk_insert(corp_type_table, [{"code": "BCR", "description": "BC Registries"}])

    # Fee code, starting with EN201 as its a new product

    op.bulk_insert(fee_code_table, [{"code": "NSF01", "amount": 30}])

    # Filing Types
    op.bulk_insert(filing_type_table, [{"code": "NSF", "description": "NSF"}])
    # Fee Schedules
    op.bulk_insert(
        fee_schedule_table,
        [
