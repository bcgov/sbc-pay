...
def upgrade():
    ...
    op.add_column('payment_account', sa.Column('pad_tos_accepted_by', sa.String(length=50), nullable=True))
    op.add_column('payment_account', sa.Column('pad_tos_accepted_date', sa.DateTime(), nullable=True))
