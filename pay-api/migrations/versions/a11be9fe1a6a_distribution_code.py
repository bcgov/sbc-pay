...
def upgrade():
    ...
    distribution_code_table = op.create_table('distribution_code',
                                              sa.Column('created_on', sa.DateTime(), nullable=False),
                                              sa.Column('updated_on', sa.DateTime(), nullable=True),
                                              sa.Column('distribution_code_id', sa.Integer(), autoincrement=True,
                                                        nullable=False),
    ...
    distribution_code_link_table = op.create_table('distribution_code_link',
                                                   ...
                                                   sa.ForeignKeyConstraint(['distribution_code_id'], [
                                                       'distribution_code.distribution_code_id'], ),
                                                   sa.ForeignKeyConstraint(['fee_schedule_id'],
                                                                           ['fee_schedule.fee_schedule_id'], ),
                                                   sa.PrimaryKeyConstraint('distribution_link_id')
                                                   )
    op.add_column('fee_schedule', sa.Column('service_fee_code', sa.String(length=10), nullable=True))
    op.create_foreign_key('service_fee_code_fk', 'fee_schedule', 'fee_code', ['service_fee_code'], ['code'])
    op.add_column('payment_line_item', sa.Column('fee_distribution_id', sa.Integer(), nullable=True))
    op.add_column('payment_line_item', sa.Column('service_fees', sa.Float(), nullable=True))
    op.create_foreign_key('fee_distribution_id_fk', 'payment_line_item', 'distribution_code', ['fee_distribution_id'],
    ...
    for result in results:
        ...
        op.execute(
            'update payment_line_item set fee_distribution_id={} where fee_schedule_id={};'.format(distribution_code_id,
                                                                                                   result[0]))
    ...
    op.drop_constraint('corp_type_transaction_fee_code_fkey', 'corp_type', type_='foreignkey')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fee_distribution_id_fk', 'payment_line_item', type_='foreignkey')
    ...
    op.add_column('corp_type', sa.Column('service_gl_memo', sa.VARCHAR(length=50), autoincrement=False, nullable=True))
    op.add_column('corp_type', sa.Column('service_fee_code', sa.VARCHAR(length=10), autoincrement=False, nullable=True))
    op.add_column('corp_type', sa.Column('gl_memo', sa.VARCHAR(length=50), autoincrement=False, nullable=True))
    op.create_foreign_key('corp_type_transaction_fee_code_fkey', 'corp_type', 'fee_code', ['service_fee_code'],
                          ['code'])
