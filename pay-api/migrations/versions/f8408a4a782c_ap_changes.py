...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('ejv_files', sa.Column('is_distribution', sa.BOOLEAN(), autoincrement=False, nullable=True))
    op.drop_column('ejv_files', 'file_type')
    op.execute("delete from routing_slip_status_codes where code in "
