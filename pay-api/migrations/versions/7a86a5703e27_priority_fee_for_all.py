...
def upgrade():
    ...
    op.execute("update fee_schedule set priority_fee_code=\'PRI01\' where fee_code != \'EN107\';")


def downgrade():
    op.execute("update fee_schedule set priority_fee_code=null where filing_type_code not in ('BCRSC', 'BCAMR', 'BCAMH', 'BCAMV', 'BCRSF', 'BCRSL', 'BCRSX', 'CRCTN');")
