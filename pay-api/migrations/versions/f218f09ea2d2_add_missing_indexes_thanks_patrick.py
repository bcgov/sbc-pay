...
def upgrade():
    ...
    op.create_index(op.f('ix_invoices_routing_slip'), 'invoices', ['routing_slip'], unique=False)
    op.create_index(op.f('ix_payment_line_items_invoice_id'), 'payment_line_items', ['invoice_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_payment_line_items_invoice_id'), table_name='payment_line_items')
