...
def upgrade():
    ...
    op.add_column('routing_slips', sa.Column('cas_version_suffix', sa.Integer(), nullable=True))
    op.execute("insert into routing_slip_status_codes (code, description) values ('VOID','Voided')")
