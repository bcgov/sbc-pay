...
def upgrade():
    ...
    op.create_table('distribution_codes_version',
    ...
    op.create_index(op.f('ix_distribution_codes_version_account_id'), 'distribution_codes_version', ['account_id'],
                    unique=False)
    op.create_index(op.f('ix_distribution_codes_version_end_transaction_id'), 'distribution_codes_version',
                    ['end_transaction_id'], unique=False)
    op.create_index(op.f('ix_distribution_codes_version_operation_type'), 'distribution_codes_version',
                    ['operation_type'], unique=False)
    op.create_index(op.f('ix_distribution_codes_version_transaction_id'), 'distribution_codes_version',
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_distribution_codes_version_transaction_id'), table_name='distribution_codes_version')
    op.drop_index(op.f('ix_distribution_codes_version_operation_type'), table_name='distribution_codes_version')
    op.drop_index(op.f('ix_distribution_codes_version_end_transaction_id'), table_name='distribution_codes_version')
    op.drop_index(op.f('ix_distribution_codes_version_account_id'), table_name='distribution_codes_version')
