...
def upgrade():
    ...
    op.create_table('invoice_reference',
    ...
    op.create_index(op.f('ix_invoice_reference_invoice_number'), 'invoice_reference', ['invoice_number'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_invoice_reference_invoice_number'), table_name='invoice_reference')
