...
def upgrade():
    ...
    for inv in invoices:
        ...
        op.execute(f'update payment set invoice_amount={total}, payment_account_id={pay_account_id}  where invoice_number=\'{inv_number}\'')
    ...
    op.bulk_insert(
        status_code_table,
        [
            {'code': 'PARTIAL_PAID', 'description': 'Partially Paid'}
        ]
    )
