...
def upgrade():
    ...
    op.bulk_insert(
        ...
        [
            ...
            {'code': 'OB', 'description': 'Online Banking'},
    ...
    op.create_foreign_key(None, 'invoice', 'cfs_account', ['cfs_account_id'], ['id'])
...
def downgrade():
    ...
    op.execute('delete from payment_method where code in (\'EFT\', \'WIRE\', \'OB\', \'PAD\')')
    # ### end Alembic commands ###
