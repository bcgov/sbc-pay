...
Revision ID: 8e53af045078
Revises: daa392b64cb7
Create Date: 2019-05-10 15:27:16.692657
...
def upgrade():
    ...
    sa.Column('transaction_id', sa.String(length=10), nullable=True),
    ...
    sa.Column('corp_name', sa.String(length=150), nullable=False),
