...
class Error(Enum):
    ...
    # EFT Errors
    EFT_CREDIT_AMOUNT_UNEXPECTED = 'EFT_CREDIT_AMOUNT_UNEXPECTED', HTTPStatus.BAD_REQUEST
    EFT_INSUFFICIENT_CREDITS = 'EFT_INSUFFICIENT_CREDITS', HTTPStatus.BAD_REQUEST
    EFT_PAYMENT_ACTION_ACCOUNT_ID_REQUIRED = 'EFT_PAYMENT_ACTION_ACCOUNT_ID_REQUIRED', HTTPStatus.BAD_REQUEST
    EFT_PAYMENT_ACTION_STATEMENT_ID_REQUIRED = 'EFT_PAYMENT_ACTION_STATEMENT_ID_REQUIRED', HTTPStatus.BAD_REQUEST
    EFT_PAYMENT_ACTION_UNPAID_STATEMENT = 'EFT_PAYMENT_ACTION_UNPAID_STATEMENT', HTTPStatus.BAD_REQUEST
    EFT_PAYMENT_ACTION_REVERSAL_EXCEEDS_SIXTY_DAYS = ('EFT_PAYMENT_ACTION_REVERSAL_EXCEEDS_SIXTY_DAYS',
                                                      HTTPStatus.BAD_REQUEST)
    EFT_PAYMENT_ACTION_CREDIT_LINK_STATUS_INVALID = ('EFT_PAYMENT_ACTION_CREDIT_LINK_STATUS_INVALID',
                                                     HTTPStatus.BAD_REQUEST)
    EFT_PAYMENT_INVOICE_REVERSE_UNEXPECTED_STATUS = ('EFT_PAYMENT_INVOICE_REVERSE_UNEXPECTED_STATUS',
                                                     HTTPStatus.BAD_REQUEST)
    EFT_PAYMENT_ACTION_UNSUPPORTED = 'EFT_PAYMENT_ACTION_UNSUPPORTED', HTTPStatus.BAD_REQUEST
