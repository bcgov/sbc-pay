...
class Error(Enum):
    ...
    EFT_PARTIAL_REFUND_MISSING_LINKS = "EFT_PARTIAL_REFUND_MISSING_LINKS", HTTPStatus.BAD_REQUEST
    ...
    EFT_PAYMENT_ACTION_STATEMENT_ID_INVALID = (
        "EFT_PAYMENT_ACTION_STATEMENT_ID_INVALID",
        HTTPStatus.BAD_REQUEST,
    )
    ...
    EFT_REFUND_CHEQUE_STATUS_INVALID_ACTION = "EFT_REFUND_CHEQUE_STATUS_INVALID_ACTION", HTTPStatus.BAD_REQUEST
    ...
    PARTIAL_REFUND_SERVICE_FEES_NOT_ALLOWED = "PARTIAL_REFUND_SERVICE_FEES_NOT_ALLOWED", HTTPStatus.BAD_REQUEST
    PARTIAL_REFUND_PAYMENT_METHOD_UNSUPPORTED = "PARTIAL_REFUND_PAYMENT_METHOD_UNSUPPORTED", HTTPStatus.BAD_REQUEST
    PARTIAL_REFUND_INVOICE_NOT_PAID = "PARTIAL_REFUND_INVOICE_NOT_PAID", HTTPStatus.BAD_REQUEST
    FULL_REFUND_INVOICE_INVALID_STATE = "FULL_REFUND_INVOICE_INVALID_STATE", HTTPStatus.BAD_REQUEST
    REFUND_NOT_ALLOWED_FOR_CORP_TYPE = "REFUND_NOT_ALLOWED_FOR_CORP_TYPE", HTTPStatus.BAD_REQUEST
    REFUND_ALREADY_EXISTS = "REFUND_ALREADY_EXISTS", HTTPStatus.BAD_REQUEST
    REFUND_INSUFFICIENT_PRODUCT_AUTHORIZATION = "REFUND_INSUFFICIENT_PRODUCT_AUTHORIZATION", HTTPStatus.FORBIDDEN
    ...
    REFUND_REQUEST_UNSUPPORTED_ACTION = "REFUND_REQUEST_UNSUPPORTED_ACTION", HTTPStatus.BAD_REQUEST
    REFUND_REQUEST_INVALID_STATE = "REFUND_REQUEST_INVALID_STATE", HTTPStatus.BAD_REQUEST
    REFUND_REQUEST_DECISION_USER_NAME_REQUIRED = "REFUND_REQUEST_DECISION_USER_NAME_REQUIRED", HTTPStatus.BAD_REQUEST
    REFUND_REQUEST_DECLINE_REASON_REQUIRED = "REFUND_REQUEST_DECLINE_REASON_REQUIRED", HTTPStatus.BAD_REQUEST
    REFUND_REQUEST_REQUESTER_EMAIL_REQUIRED = "REFUND_REQUEST_REQUESTER_EMAIL_REQUIRED", HTTPStatus.BAD_REQUEST
    REFUND_REQUEST_SAME_USER_APPROVAL_FORBIDDEN = "REFUND_REQUEST_SAME_USER_APPROVAL_FORBIDDEN", HTTPStatus.FORBIDDEN
    ...
    EJV_PAYMENT_METHOD_RESTRICTED = "EJV_PAYMENT_METHOD_RESTRICTED", HTTPStatus.UNPROCESSABLE_ENTITY
