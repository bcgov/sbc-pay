...
class PaymentMethod(db.Model, CodeTable):
    ...
    __mapper_args__ = {"include_properties": ["code", "description", "partial_refund", "full_refund_statuses"]}

    code = db.Column(db.String(15), primary_key=True)
    description = db.Column("description", db.String(200), nullable=False)
    partial_refund = db.Column(db.Boolean, nullable=False, default=False)
    full_refund_statuses = db.Column(db.ARRAY(db.String()), nullable=True)
    ...
    @classmethod
    def is_partial_refund_allowed(cls, payment_method_code: str) -> bool:
