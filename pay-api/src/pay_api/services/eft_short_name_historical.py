...
class EFTShortnameHistorical:
    ...
    @staticmethod
    @user_context
    def create_invoice_refund(history: EFTShortnameHistory, is_partial_refund: bool = False,  **kwargs) -> EFTShortnamesHistoricalModel:
        ...
        return EFTShortnamesHistoricalModel(
            ...
            transaction_date=EFTShortnameHistorical.transaction_date_now(),
            transaction_type=EFTHistoricalTypes.INVOICE_PARTIAL_REFUND.value
            if is_partial_refund else EFTHistoricalTypes.INVOICE_REFUND.value,
        )
