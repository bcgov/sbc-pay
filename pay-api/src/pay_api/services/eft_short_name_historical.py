...
class EFTShortnameHistorical:
    ...
    @staticmethod
    def create_funds_received(history: EFTShortnameHistory) -> EFTShortnamesHistoricalModel:
    ...
    def search(cls, short_name_id: int,
        ...
        query = (db.session.query(history_model.id,
                 ...
                 .outerjoin(PaymentAccountModel, PaymentAccountModel.id == history_model.payment_account_id)
