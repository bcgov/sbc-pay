...
class CreateAccountTask:  # pylint: disable=too-few-public-methods
    ...
    def create_accounts(cls):  # pylint: disable=too-many-locals
        ...
        for pending_account in pending_accounts:
            ...
            try:
                ...
                if pay_account.payment_method in (
    ...
    @classmethod
    def _create_cfs_account(
        cls,
        pending_account: CfsAccountModel,
        ...
        try:
            ...
            if pay_account.payment_method == PaymentMethod.EFT.value:
                ...
                if (
                    pending_account.bank_number
                    and pending_account.bank_branch_number
        ...
        pending_account.status = (
            ...
            if is_account_in_pad_confirmation_period
