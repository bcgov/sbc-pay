...
from pay_api.utils.enums import CfsAccountStatus, DisbursementStatus, InvoiceStatus, PaymentMethod, RefundsPartialType
...
from .factory import (
    ...
    factory_invoice_reference, factory_payment, factory_payment_line_item, factory_receipt, factory_refund_partial_line)
...
def test_disbursement_for_partners(session, monkeypatch, client_code, batch_type):
    ...
    2) Create partial refund invoices for these partners.
    ...
    payment_line_item = factory_payment_line_item(invoice_id=invoice.id,
    ...
    factory_refund_partial_line(payment_line_item.id, 1.5, RefundsPartialType.SERVICE_FEE.value)
