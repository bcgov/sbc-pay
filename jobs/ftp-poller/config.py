...
class _Config(object):  # pylint: disable=too-few-public-methods
    ...
    BCREG_FTP_PRIVATE_KEY_LOCATION = os.getenv(
        "BCREG_FTP_PRIVATE_KEY_LOCATION", "/ftp-poller/key/sftp_priv_key"
    )  # full path to the privatey key
    BCREG_FTP_PRIVATE_KEY_PASSPHRASE = os.getenv("BCREG_FTP_PRIVATE_KEY_PASSPHRASE", "")

    # CGI FTP CONFIG
    BCREG_CGI_FTP_PRIVATE_KEY_LOCATION = os.getenv(
        "BCREG_CGI_FTP_PRIVATE_KEY_LOCATION", "/ftp-poller/key/cgi_sftp_priv_key"
    )  # full path to the privatey key
    ...
    # EFT FTP CONFIG
    BCREG_EFT_FTP_PRIVATE_KEY_LOCATION = os.getenv(
        "BCREG_EFT_FTP_PRIVATE_KEY_LOCATION", "/ftp-poller/key/eft_sftp_priv_key"
    )
