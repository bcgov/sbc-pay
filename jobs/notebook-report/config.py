...
class Config:
    ...
    BCA_RECONCILIATION_RECIPIENTS = os.getenv("BCA_RECONCILIATION_RECIPIENTS", "")
    ...
    MONTHLY_RECONCILIATION_PARTNERS = os.getenv("MONTHLY_RECONCILIATION_PARTNERS", "CSO,VS,RPT,ESRA,BCA")

    PARTNER_CODES = os.getenv("PARTNER_CODES", "CSO,VS,RPT,ESRA,STRR,BCA")
    PARTNER_CODES_DISBURSEMENT = os.getenv("PARTNER_CODES_DISBURSEMENT", "CSO,VS,STRR,ESRA,BCA")
